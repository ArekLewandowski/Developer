...
public class ReservationServiceTest {
	...
	public void testShouldAddReservation() {
		...
		// then
		Assert.assertEquals("FREE", flatTO.getStatus());
		Assert.assertEquals("RESERVED", reservedFlat.getStatus());
	...
	public void testShouldAddCancelReservation() {
		...
		Assert.assertEquals("FREE", flatTO.getStatus());
		Assert.assertEquals("RESERVED", reservedFlat.getStatus());
		Assert.assertEquals("FREE", canceledReservationFlat.getStatus());
	...
	public void testShouldBuyFlatWithFreeStatus() {
		...
		// then
		Assert.assertEquals("FREE", flatTO.getStatus());
		Assert.assertEquals("SOLD", soldFlat.getStatus());
		Assert.assertEquals(clientTO.getId(), addedOwnerId);
	...
	@Test
	public void testShouldGetOwner() {
		...
		// when
		ClientTO ownerflatTO = reservationService.getFlatOwner(flatTO.getId());

		// then
		Assert.assertEquals(clientTO.getLastName(), ownerflatTO.getLastName());
	}

	@Test
	public void testShouldGetCoowner() {
		...
		reservationService.buyFlatWithCoowners(flatTO, clientTO, coowners);

		// when
		List<ClientTO> coowner = reservationService.getFlatCoowner(flatTO.getId());

		// then
		Assert.assertEquals(1, coowner.size());
	}

	@Test
	public void testShouldGetStatus() {
		...
		// when
		String status = reservationService.getFlatStatus(flatTO.getId());
